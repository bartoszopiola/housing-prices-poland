...
Podobnie jak AIC, metoda Hellwiga jest to metoda doboru zmiennych objaśniających do modelu ekonometrycznego. Metoda Hellwiga skupia się na znalezieniu silnej korelacji zmiennych objaśnianych ze zmienną objaśnianą oraz słabej korelacji pomiędzy zmiennymi objaśniającymi. Dodatkowo kieruje się integralnymi wskaźnikami pojemności informacyjnej <b>[`H`]</b> czyli sumą pojedyńczych pojemności <b>[`h`]</b> w każdej kombinacji.
